...
export const guildVoiceEventsRelations = relations(
  guildVoiceEvents,
  ({ one }) => ({
    guild: one(guild, {
...
export const memberCommandHistoryRelations = relations(
  memberCommandHistory,
  ({ one }) => ({
    guild: one(guild, {
...
export const memberDeletedMessagesRelations = relations(
  memberDeletedMessages,
  ({ one }) => ({
